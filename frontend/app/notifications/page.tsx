...
export default function NotificationsPage() {
  ...
  // ==========================================
  // ENABLE / TEST BROWSER NOTIFICATIONS
  // ==========================================
  ...
  const enableBrowserNotifications = async () => {
    ...
    try {
      ...
      if (Notification.permission === "granted") {
        ...
        new Notification("CarMarket Notifications", {
          body: "Browser notifications are working successfully!",
          icon: "/favicon.ico",
        });
      ...
      if (permission === "granted") {
        ...
        setMessage(
          "Browser notification permission was denied. Please allow notifications in Chrome site settings."
        );
      } else {
        setMessage(
          ...
          <div className="mt-6 rounded-2xl bg-white p-5 shadow-lg sm:p-6 md:p-8">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-gray-200 p-5">
                ...
                <div className="mt-4 rounded-lg bg-green-50 p-3 text-center font-semibold text-green-700">
                  {preferences.browser
